...
writer = SummaryWriter(log_dir='./logs/inception_v3_aug', comment="with augmentation")
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                writer.add_embedding(outputs, metadata=labels.data, label_img=inputs.data, global_step=epoch,
                                     tag='out_label_in_{}'.format(phase))
...
torch.save(model_ft.state_dict(), 'inceptionV3_pretrained_iter{}.pkl'.format(300))
dummy_input = torch.utils.data.DataLoader(image_datasets['val'], batch_size=1,
