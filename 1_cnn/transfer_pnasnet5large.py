...
writer = SummaryWriter(log_dir='./logs/pnasnet5large', comment="with augmentation")
...
data_dir = '/home/arthur/Desktop/skin-10-balanced-3'
...
model_ft.last_linear = nn.Linear(model_ft.last_linear.in_features, 10)
...
optimizer_ft = optim.Adam(model_ft.parameters(), lr=1e-4, betas=(0.9,0.999), eps=1e-08,
...
torch.save(model_ft.state_dict(), '../../pkls/pnasnet5large_pretrained_iter{}.pkl'.format(300))
dummy_input = Variable(torch.rand(1, 3, 331, 331))
